...
bool Map::Update(float dt)
{
    ...
    int Xi = app->sceneManager->currentScene->GetPlayer()->GetTile().x - 15;//- 10
    int Xf = app->sceneManager->currentScene->GetPlayer()->GetTile().x + 15;//+ 5 
    int Yi = app->sceneManager->currentScene->GetPlayer()->GetTile().y - 15;//- 10
    int Yf = app->sceneManager->currentScene->GetPlayer()->GetTile().y + 15;//+ 10
