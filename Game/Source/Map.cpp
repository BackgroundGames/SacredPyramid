...
bool Map::Update(float dt)
{
    ...
    int Xi = app->sceneManager->currentScene->GetPlayer()->GetTile().x - 13;
    int Xf = app->sceneManager->currentScene->GetPlayer()->GetTile().x + 10;
    int Yi = app->sceneManager->currentScene->GetPlayer()->GetTile().y - 12;
    int Yf = app->sceneManager->currentScene->GetPlayer()->GetTile().y + 11;
